        ...
        child: FadeTransition(
          ...
          child: AnimatedBuilder(
            ...
            child: Column(
              ...
              children: [
                // Logo image
                Image.asset('assets/logo/mcc.png', width: 160, height: 160),
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<_OnboardData> _pages = const [
    _OnboardData(
      ...
      subtitle: 'Morocco - China',
      desc:
          'MCC Partners connecte les entreprises marocaines et chinoises en trajectoires économiques durables, fondées sur la confiance et l\'intelligence culturelle.',
    ),
    _OnboardData(
      emoji: '🏛',
      ...
      desc:
          'Participez au Webinaire du 11 Mai et au Salon MCC dans la région de l\'Oriental. Deux rendez-vous majeurs pour bâtir les partenariats de demain.',
    ),
    _OnboardData(
      emoji: '🤝',
      ...
      desc:
          'Trouvez des partenaires qualifiés, échangez des messages et prenez des rendez-vous directement dans l\'application.',
    ),
  ];
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: accent == MCCColors.yellow
                            ? MCCColors.ink
                            : MCCColors.white,
                        elevation: 0,
