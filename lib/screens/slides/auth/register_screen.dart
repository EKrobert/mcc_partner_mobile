      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/logo/mcc.png', width: 80, height: 80),
              TextButton(
          ...
          const SizedBox(height: 4),
          Text(
            'Rejoignez l\'écosystème MCC Partners',
            style: GoogleFonts.poppins(
              fontSize: 13,
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: Container(
            height: 2,
            color: _step > 0 ? accent : MCCColors.border,
          ),
        ),
        _StepDot(
          num: 2,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Center(
              child: Icon(Icons.check, color: MCCColors.green, size: 40),
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _SuccessRow(
                  'Entreprise',
                  _entrepriseCtrl.text.isEmpty ? '—' : _entrepriseCtrl.text,
                ),
                _SuccessRow(
                  'Profil',
                  _isChinese
  ...
  InputDecoration _inputDeco({
    ...
    return InputDecoration(
      ...
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8),
        borderSide: const BorderSide(color: MCCColors.red),
      ),
